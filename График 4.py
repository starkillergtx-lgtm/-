...
ax.set_title(
    ...
    'Интерполяция: полином Лагранжа 3-й степени по 4 опорным точкам; MOS=2.5 исключён',
    fontsize=13,
    fontweight='bold',
    pad=22,
    color='#111111',
...
print("\nДиагностика интерполяции Лагранжа для графика 4:")
...
plt.tight_layout()
plt.savefig(
    'qoe_step4_final_6levels_lagrange_uhd.png',
    dpi=180,
    bbox_inches='tight',
    facecolor='white',
    edgecolor='none',
...
print("\n✓ График 4 сохранён: qoe_step4_final_6levels_lagrange_uhd.png")
print("✓ Таблица уровней сохранена: qoe_step4_final_6levels_uhd_levels.csv")
if files is not None:
    files.download('qoe_step4_final_6levels_lagrange_uhd.png')
