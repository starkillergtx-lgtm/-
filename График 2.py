...
def draw_itu(ax, y_bot, y_top):
    # Текст сдвинут правее, чтобы дать воздух подписям точек
    x_pos = 1.28
...
plt.savefig(
    'qoe_average_ladder_lagrange_poly_v2.png',
    dpi=200,
    bbox_inches='tight',
    facecolor='white',
    edgecolor='none'
...
print("\n✓ График формирования лестницы сохранён: qoe_average_ladder_lagrange_poly_v2.png")
files.download('qoe_average_ladder_lagrange_poly_v2.png')
