...
# Заголовки
ax.set_title(
    'График 3: Итоговая перцептивная QoE-лестница (6 уровней)\n'
...
plt.savefig(
    'qoe_step4_final_6levels_lagrange_poly_log.png',
    dpi=180,
    bbox_inches='tight',
    facecolor='white',
    edgecolor='none'
...
print("\n✓ Логарифмический график 3 успешно сгенерирован и сохранён как: qoe_step4_final_6levels_lagrange_poly_log.png")
files.download('qoe_step4_final_6levels_lagrange_poly_log.png')