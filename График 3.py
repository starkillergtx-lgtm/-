...
plt.tight_layout()
plt.savefig('qoe_step3_7levels_lagrange_poly.png', dpi=180, bbox_inches='tight')
plt.show()

print("\n✓ График 3 успешно сгенерирован и сохранён как: qoe_step3_7levels_lagrange_poly.png")
files.download('qoe_step3_7levels_lagrange_poly.png')